...
namespace MiscTelemetry {
    [EventSource(Name = "MyCompany-TK_ETWAppInsightMetrics-MiscTelemetry")]
    internal sealed class ServiceEventSource : EventSource {
        ...
        public static class Keywords {
            public const EventKeywords Requests = (EventKeywords)0x01L;
            public const EventKeywords ServiceInitialization = (EventKeywords)0x02L;
            public const EventKeywords TKKeyword = (EventKeywords)0x04L;
        }
        #endregion
        ...
        private const int TKEventTransactionRollback = 100;
        [Event( TKEventTransactionRollback, Level = EventLevel.Warning, Message = "{0}", 
                Keywords = Keywords.TKKeyword
            )]
        public void WarningRollback(string message) {
            if (this.IsEnabled()) {
                WriteEvent(TKEventTransactionRollback, message);
            }
        }
        #endregion
    }
